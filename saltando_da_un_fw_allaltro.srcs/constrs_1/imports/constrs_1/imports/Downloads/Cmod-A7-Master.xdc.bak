...
connect_debug_port u_ila_0/probe0 [get_nets [list {icap_out_OBUF[0]} {icap_out_OBUF[1]} {icap_out_OBUF[2]} {icap_out_OBUF[3]} {icap_out_OBUF[4]} {icap_out_OBUF[5]} {icap_out_OBUF[6]} {icap_out_OBUF[7]} {icap_out_OBUF[8]} {icap_out_OBUF[9]} {icap_out_OBUF[10]} {icap_out_OBUF[11]} {icap_out_OBUF[12]} {icap_out_OBUF[13]} {icap_out_OBUF[14]} {icap_out_OBUF[15]}]]
...
connect_debug_port u_ila_0/probe2 [get_nets [list {icap_in[0]} {icap_in[1]} {icap_in[3]} {icap_in[15]} {icap_in[17]} {icap_in[24]} {icap_in[25]} {icap_in[28]} {icap_in[29]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list go_IBUF]]
create_debug_port u_ila_0 probe
